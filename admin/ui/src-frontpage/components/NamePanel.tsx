...
function NavItem(item: IndiceItem, location, numItemActivo: any) {
  ...
  return (
    <Link
      ...
      className={`panel p-2 rounded-lg mb-4 h-20 sm:h-10 md:h-14 lg:h-18 xl:h-20 flex justify-center text-center items-center cursor-pointer no-underline hover:bg-black`}
